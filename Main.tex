...
\subsection{Molecular spectral fitting}

% Explain the physical problem.
% Give the necessary background for readers unfamiliar with the topic.
% Keep this concise.

\subsection{Existing software}

% Introduce Molecfit and any other relevant software.
%
% Explain what these packages do well.
% Explain their limitations that motivated PyMolFit.

\subsection{Motivation for PyMolFit}

% Explain the design goals.
%
...
%
% Explain what originates from Molecfit.
% Explain what has been modified.
% Explain what is entirely new.
%
% State clearly that PyMolFit builds upon Molecfit while extending
% its capabilities.

\subsection{External resources}

% Describe external models and databases.
%
% Atmospheric models
% Weather models
% Molecular line databases
%
% Explain that these are existing scientific resources
% integrated into PyMolFit.
